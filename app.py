...
client = OpenAI(
    api_key="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",
...
def predict():
    ...
    diseases = request.form.getlist("diseases")  # Add this in your form (checkboxes for diseases)
